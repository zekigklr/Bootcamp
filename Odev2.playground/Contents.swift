...
class KenarSayisi {
    ...
    func icAcilarToplami(ks: Int) -> Int {
        if ks > 2 {
            let islem = ((ks - 2) * 180 )
            print("Soru 1 : İc acılar toplamı : \(islem) derecedir")
            return islem
        }else{
            print("Soru 1 : Minimum 3 giriniz.")
            return ks
        }
    }
}
...
class MaasHesabi {
    ...
    func maasHesabi(gun: Int) -> Int {
        ...
        if islem > 1600 {
            ...
            print("Soru 2 : Mesai ücretleriyle beraber \(mesai)₺ kazandınız.")
            return mesai
        }else {
            print("Soru 2 : Mesai yok. Kazanılan ücret \(islem)₺'dir.")
            return islem
        }
    }
}
...
class Kota {
    ...
    func hesaplama(kota: Int) -> Int {
        ...
        if ucret > 100 {
            ...
            print("Soru 3 : Kota kullanım tutarınız aşım ücreti ile beraber \(ucret)₺'dir")
            return ucret
        }
        else{
            print("Soru 3 : Kota kullanım tutarınız \(ucret)₺'dir")
            return ucret
        }
    }
}
...
class Fahrenhiet {
    ...
    func change(celcius: Double) -> Double {
        ...
        print("Soru 4 : \(celcius) celcius = \(fahrenhiet) fahrenheit")
        return fahrenhiet
    }
}
...
class Dikdortgen {
    ...
    func cevre(x: Int, y: Int){
        let cevre = 2 * (x + y)
        print("Soru 5 : Dikdörtgenin cevre uzunlugu toplamı = \(cevre).")
    }
}
var f = Dikdortgen()
f.cevre(x: 10, y: 5)
...
func faktoriyel( sayi : Int ) -> Int {
    ...
    print ("Soru 6 : \(faktoriyel(sayi: 5))")
//--------------------------------------------------------------------------//
//Soru 7
//--------------------------------------------------------------------------//
func buraya(kelimegirin: String) -> Int{
    ...
    print("Soru 7 : Metnin içinde \(x) tane 'a' harfi bulunuyor.")
    return x
